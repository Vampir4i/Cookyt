...
import cookyt.salads.one.ClickListener
import cookyt.salads.one.R
import cookyt.salads.one.RecyclerTouchListener
import cookyt.salads.one.adapter.NavigationRVAdapter
import cookyt.salads.one.databinding.ActivityMainBinding
