...
import cookyt.soups.one.ClickListener
import cookyt.soups.one.R
import cookyt.soups.one.RecyclerTouchListener
import cookyt.soups.one.adapter.NavigationRVAdapter
import cookyt.soups.one.databinding.ActivityMainBinding
import cookyt.soups.one.model.NavigationItemModel
...
class MainActivity : AppCompatActivity() {
    ...
    private var items = listOf(
        NavigationItemModel(R.drawable.baseline_video_library_24, App.context.getString(R.string.l_new_video)),
        NavigationItemModel(R.drawable.baseline_view_list_24, App.context.getString(R.string.l_category)),
        NavigationItemModel(R.drawable.baseline_favorite_24, App.context.getString(R.string.l_favorites)),
        NavigationItemModel(R.drawable.ic_baseline_history_24, App.context.getString(R.string.l_recent))
    )
    private var items1 = listOf(
//        NavigationItemModel(R.drawable.ic_baseline_rate_review_24, "Оцени нас"),
        NavigationItemModel(R.drawable.ic_baseline_more_24, App.context.getString(R.string.l_more)),
//        NavigationItemModel(R.drawable.baseline_share_24, "Поделиться"),
        NavigationItemModel(R.drawable.ic_baseline_info_24, App.context.getString(R.string.l_about_us)),
        NavigationItemModel(R.drawable.ic_baseline_lock_24, App.context.getString(R.string.l_terms))
    )
            ...
            override fun onClick(view: View, position: Int) {
                when(position) {
                    ...
                    2 -> {
                        ...
                        binding.subTitle = getString(R.string.l_favorites)
                    }
                    3 -> {
                        vm.action.value = vm.T_HISTORY
                        binding.subTitle = getString(R.string.l_history)
                    }
                }
...
//                    }
                    1 -> {
                        ...
                        binding.subTitle = getString(R.string.l_about_us)
                    }
                    2 -> {
